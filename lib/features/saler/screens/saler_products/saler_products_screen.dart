...
import 'package:quad_b/features/saler/screens/saler_products/saler_add_product.dart';
import 'package:quad_b/features/saler/screens/saler_products/saler_edit_product.dart';
import 'package:quad_b/features/saler/screens/saler_products/saler_product_details.dart';
...
class SalerProductsScreen extends StatelessWidget {
  const SalerProductsScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: WAppBarWidget("Saler Products"),
        body: StreamBuilder(
