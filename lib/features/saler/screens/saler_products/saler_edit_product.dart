...
import 'package:quad_b/features/saler/screens/saler_products/saler_product_dropdown.dart';
import 'package:quad_b/features/saler/screens/saler_products/saler_product_images.dart';
...
class WEditProductScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(()=>Scaffold(
      appBar: WAppBarWidget("Saler Edit Product"),
      body: Padding(
