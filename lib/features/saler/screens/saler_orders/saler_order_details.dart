...
import 'package:quad_b/features/saler/screens/saler_orders/saler_order_place.dart';

import '../../../../constants/colors.dart';
import '../../controllers/saler_orders_controller.dart';
...
class _WOrderDetailsState extends State<WOrderDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => Scaffold(
        appBar: WAppBarWidget("Saler Order Details"),
