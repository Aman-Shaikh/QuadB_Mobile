...
import 'package:quad_b/features/saler/screens/saler_orders/saler_order_details.dart';

import '../../../../constants/colors.dart';
import '../saler_home/wholesaler_appbar_widget.dart';

class SalerOrdersScreen extends StatelessWidget {
  const SalerOrdersScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: WAppBarWidget("Saler Orders"),
      body: StreamBuilder(
