...
import 'package:quad_b/features/saler/screens/saler_home/wholesaler_appbar_widget.dart';
import 'package:quad_b/features/saler/screens/saler_home/whs_button_widget.dart';
import 'package:velocity_x/velocity_x.dart';

import '../../../../constants/colors.dart';
import '../../../../constants/image_strings.dart';
import '../saler_products/saler_product_details.dart';

class SalerHomeScreen extends StatelessWidget {
  const SalerHomeScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
          appBar: WAppBarWidget("Saler Dashboard"),
          body: StreamBuilder(
