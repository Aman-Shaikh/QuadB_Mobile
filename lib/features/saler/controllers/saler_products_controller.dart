...
class ProductsController extends GetxController {
  ...
  getCategories() async {
    var data = await rootBundle
        .loadString("lib/features/Saler/models/category_model.json");
  ...
  uploadProduct(context) async {
    ...
    await store
        ...
        .catchError((error, stackTrace) {
          Get.snackbar("Error",
              "Something went wrong product can not be added please check the Saler_products_controller file.",
              snackPosition: SnackPosition.BOTTOM,
              backgroundColor: Colors.redAccent.withOpacity(0.1),
              colorText: Colors.red);
  ...
  addFeatured(docId) async {
    await FirebaseFirestore.instance
        ...
        .catchError((error, stackTrace) {
          Get.snackbar("Error",
              "Something went wrong please check the add feature function in Saler_products_controller file.",
              snackPosition: SnackPosition.BOTTOM,
              backgroundColor: Colors.redAccent.withOpacity(0.1),
              colorText: Colors.red);
          print(error.toString());
  ...
  removeFeatured(docId) async {
    await FirebaseFirestore.instance
        ...
        .catchError((error, stackTrace) {
          Get.snackbar("Error",
              "Something went wrong please check the remove feature function in Saler_products_controller file.",
              snackPosition: SnackPosition.BOTTOM,
              backgroundColor: Colors.redAccent.withOpacity(0.1),
              colorText: Colors.red);
          print(error.toString());
  ...
  removeProduct(docId) async {
    ...
    await FirebaseFirestore.instance
        ...
        .catchError((error, stackTrace) {
      Get.snackbar("Error",
          "Something went wrong please check the removeProduct function in Saler_products_controller file.",
          snackPosition: SnackPosition.BOTTOM,
          backgroundColor: Colors.redAccent.withOpacity(0.1),
          colorText: Colors.red);
      print(error.toString());
  ...
  Future<void> removeImages(docId) async {
    ...
    for (int i = 0; i < len; i++) {
      ...
      //   Get.snackbar("Error",
      //       "Not able to delete images please check the removeProduct function in Saler_products_controller file.",
      //       snackPosition: SnackPosition.BOTTOM,
      //       backgroundColor: Colors.redAccent.withOpacity(0.1),
      //       colorText: Colors.red);
      // });
